...
export default function HistoryPage() {
  ...
  const loadOrders = async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/orders?status=all&page=${page}&limit=50&sortBy=${sortBy}&sortOrder=${sortOrder}`);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <>
            ...
            <HistoryTable orders={orders} showActions={false} onSort={handleSort} />
