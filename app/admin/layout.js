...
import { Users, DollarSign, LogOut, LayoutDashboard, Settings, TrendingUp, BarChart3 } from 'lucide-react';
...
export default function AdminLayout({ children }) {
  ...
  const menuItems = [
    ...
    { href: '/admin/analytics', label: 'تحلیل و آمار', icon: BarChart3 }, // New
    { href: '/admin/users', label: 'مدیریت کاربران', icon: Users },
    { href: '/admin/finance', label: 'امور مالی', icon: DollarSign },
    { href: '/admin/marketing', label: 'کمپین و تخفیف', icon: TrendingUp }, // Renamed for clarity
